...
public class DemonHelmet extends ArmorItem {

    public DemonHelmet(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
        ...
        if (!player.isPotionActive(Effects.RESISTANCE)) {
            player.addPotionEffect(new EffectInstance(Effects.RESISTANCE, 1000, 1,false, false));
            // Feed the player
